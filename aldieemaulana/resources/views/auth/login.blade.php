...
<div class="login-container">
    <div class="p-l-50 m-l-10 p-r-50 m-r-10 m-t-40 sm-p-l-15 sm-p-r-15 sm-p-t-40 text-center">
        ...
        {{ csrf_field() }}
            ...
            <button class="btn btn-success btn-block m-t-30" style="background: #006130; border-color: #006130;font-family: 'Lato', sans-serif;font-weight: 600;color: #FFF;border-radius: 20px;" type="submit">LOG IN</button>
        </form>
