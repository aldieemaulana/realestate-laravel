...
@section('button')
    <a href="{{ url('/manager/dashboard') }}" class="btn btn-info btn-xs no-border">Back</a>
@endsection

@section('content')
    {!! Form::open(['url' => 'manager/dashboard/'.$id.'/'.$title, 'id' => 'formValidate', 'files' => true]) !!}
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group form-group-default form-group-default-select2 required {{ $errors->has('status') ? 'has-error' : ''}}">
                                    ...
                                    <select class="full-width" data-init-plugin="select2" required name="status">
                                ...
                                <div class="form-group form-group-default {{ $errors->has('telepon') ? 'has-error' : ''}}">
                                    <div class="form-input-group ">
                                        ...
                                        <input type="text" class="form-control tanggal-picker" placeholder="Pick a date" name="tanggal_wawancara">
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group form-group-default {{ $errors->has('booking_fee') ? 'has-error' : ''}}">
                                            <div class="form-input-group ">
                                                ...
                                                <input type="text" class="form-control autonumeric" data-a-sign="Rp " placeholder="-" name="booking_fee">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group form-group-default {{ $errors->has('tanggal_booking_fee') ? 'has-error' : ''}}">
                                            <div class="form-input-group ">
                                                ...
                                                <input type="text" class="form-control tanggal-picker" placeholder="Pick a date" name="tanggal_booking_fee">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-7">
                                        <div class="form-group form-group-default {{ $errors->has('dp_'.$i) ? 'has-error' : ''}}">
                                            <div class="form-input-group ">
                                                ...
                                                <input type="text" class="form-control autonumeric" data-a-sign="Rp " placeholder="-" name="{{ 'dp_'.$i }}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group form-group-default {{ $errors->has('tanggal_dp_'.$i) ? 'has-error' : ''}}">
                                            <div class="form-input-group ">
                                                ...
                                                <input type="text" class="form-control tanggal-picker" placeholder="Pick a date" name="{{ 'tanggal_dp_'.$i }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row m-t-5">
                                            <div class="col-md-8">
                                                <div class="form-group form-group-default">
                                                    <div class="form-input-group ">
                                                        ...
                                                        <input type="tanggal_bayar" class="form-control" placeholder="Pick a date" name="tanggal_bayar" id="tanggal_bayar">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-2">
                                                <div aria-required="true" class="form-group {{ $errors->has('bayar') ? 'has-error' : ''}}">
                                                    <div class="checkbox check-info">
                                                        <input type="checkbox" value="1" id="bayar" name="bayar">
                                        ...
                                        <div class="row m-t-10">
                                            <div class="col-md-12">
                                                <div class="form-group form-group-default form-group-default-select2">
                                                        ...
                                                        <select class="full-width" data-init-plugin="select2" id="metode" name="metode_bayar">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group form-group-default">
                                                    <div class="form-input-group ">
                                                        ...
                                                        <input type="text" class="form-control tanggal-picker" placeholder="Pick a date" name="tanggal_akad" id="tanggal_akad">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group form-group-default">
                                                    <div class="form-input-group ">
                                                        ...
                                                        <input type="text" class="form-control tanggal-picker" placeholder="Pick a date" name="tanggal_cair" id="tanggal_cair">
                                                    </div>
                                                </div>
