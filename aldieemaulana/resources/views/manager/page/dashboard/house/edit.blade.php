...
@section('title', 'Edit Detail Pembelian Rumah')
...
@section('content')
    {!! Form::model($bo, [
      'method' => 'PATCH',
      'url' => ['manager/dashboard/'.$id.'/'.$title.'/edit'],
      'files' => true,
      'id' => 'formValidate',
      ]) !!}
    ...
    <input id="deleteID" type="hidden" value="{{ $bo->id_house }}"/>
    <div class="container-fluid container-fixed-lg">
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <a class="btn btn-danger btn-rounded btn-sm p-l-30 p-r-30 m-l-10 pull-right"  onClick="deleteData({{ $bo->id_house }})" >DELETE</a>
