      ...
      <div class="header">
        <div class="container-fluid relative">
          ...
          <div class=" pull-right">
                ...
                text-align: center;color: #fff;"></i> {{ ucwords(Auth::User()->username) }}</span></button>
          ...
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              <div class="modal-header">
                  <h5>Hapus <span class="semi-bold">Data?</span><br/> <small>Data terhubung akan terhapus!</small></h5>
              </div>
              <div class="modal-body text-center">
                <button class="btn btn-danger btn-sm" onclick="hapus()">Ya, Saya mengerti</button>
              </div>
            </div>
          </div>
        </div>

  			<!-- MODAL STICK UP CONFIRM  -->
        <div class="modal fade stick-up" id="modalConfirm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-sm">
            <div class="modal-content">
              <div class="modal-header">
                  <h5>Confirm Fee sudah <span class="semi-bold">cair?</span><br/> <small>Data terhubung akan terbarui!</small></h5>
              </div>
              <div class="modal-body text-center">
                <button class="btn btn-danger btn-sm" onclick="confirm()">Ya, Saya mengerti</button>
              </div>
            </div>
          </div>
        </div>
